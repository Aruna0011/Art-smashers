-- Complete Supabase Setup for Campus Art Hub
-- Run this entire script in your Supabase SQL Editor
-- This includes: Database schema, admin user, policies, and all configurations
...
DROP POLICY IF EXISTS "Public access for contact messages" ON public.contact_messages;
DROP POLICY IF EXISTS "Admins can manage contact messages" ON public.contact_messages;
DROP POLICY IF EXISTS "Public access for image management" ON public.image_management;
DROP POLICY IF EXISTS "Admins can manage image management" ON public.image_management;
...
DROP TABLE IF EXISTS public.image_management CASCADE;
